...
STAGE_MODULES: dict[str, tuple[str, ...]] = {
    ...
    "context_select": ("context_extension.py", "context_manifest.py"),
    "context_prepare": ("context_extension.py", "context_manifest.py"),
    "context_pack": ("context_extension.py", "context_manifest.py"),
    "context_verify": ("context_extension.py", "context_manifest.py"),
